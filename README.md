...
#### Evaluation & Metrics
The model is evaluated on the Kaggle Toxic Comment test set, with unlabelled rows ($y = -1$) strictly filtered out to ensure statistical validity.
Metrics Tracked:  F1-Score, AUC Score,Average score
